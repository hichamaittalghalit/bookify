...
@section('title', 'Create PayPal Account')
@section('page-title', 'Create PayPal Account')

@section('content')
<div class="bg-white rounded-lg shadow p-6 max-w-4xl">
    <form action="{{ route('admin.paypals.store') }}" method="POST" class="space-y-6">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" id="test_client_id" name="test_client_id" value="{{ old('test_client_id') }}" required
                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
            ...
            <div>
                ...
                <input type="text" id="test_secret_key" name="test_secret_key" value="{{ old('test_secret_key') }}" required
                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
            ...
            <div>
                ...
                <input type="text" id="live_client_id" name="live_client_id" value="{{ old('live_client_id') }}"
                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
            ...
            <div>
                ...
                <input type="text" id="live_secret_key" name="live_secret_key" value="{{ old('live_secret_key') }}"
                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
