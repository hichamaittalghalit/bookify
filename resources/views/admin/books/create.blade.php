        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2 border-t pt-6">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" id="seo_title" name="seo_title" value="{{ old('seo_title') }}" maxlength="255"
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                    ...
                    <div>
                        ...
                        <textarea id="seo_description" name="seo_description" rows="3" maxlength="500"
                                  class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                                  placeholder="Leave empty to use book description">{{ old('seo_description') }}</textarea>
            ...
            <div class="md:col-span-2">
                ...
                <input type="file" id="image" name="image" accept="image/*" required
                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                <p class="mt-1 text-xs text-gray-500">Max 2MB. Formats: JPEG, PNG, JPG, GIF, WEBP</p>
